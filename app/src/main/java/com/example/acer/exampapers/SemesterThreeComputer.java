...
public class SemesterThreeComputer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(SemesterThreeComputer.this);
    ...
    public void addSubjectData(){
        ...
        branch_obj = new Branch("Communication Pri.& App");
        SemesterList.add(branch_obj);
