...
public class SemesterThreeElectronics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(SemesterThreeElectronics.this);
    ...
    public void addSubjectData(){
        ...
        branch_obj = new Branch("Signals and Systems");
        SemesterList.add(branch_obj);

        branch_obj = new Branch("Linear Circuit Analysis");
        SemesterList.add(branch_obj);

        branch_obj = new Branch("Analog Electronics");
        SemesterList.add(branch_obj);
