...
public class SemesterEC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(SemesterEC.this);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(this,
            ...
            public void onClick(View view, final int position) {
                switch (position) {
                    case 0: {
                        Intent i = new Intent(SemesterEC.this, SemesterOneEC.class);
                        startActivity(i);
                        break;
                    }
                    case 1:{
                        Intent i = new Intent(SemesterEC.this, SemesterTwoEC.class);
                        startActivity(i);
                        break;
                    }
                    case 2: {
                        Intent i = new Intent(SemesterEC.this, SemesterThreeEC.class);
                        startActivity(i);
                        break;
                    }
                    case 3: {
                        Intent i = new Intent(SemesterEC.this, SemesterFourEC.class);
                        startActivity(i);
                        break;
                    }
                    case 4: {
                        Intent i = new Intent(SemesterEC.this, SemesterFiveEC.class);
                        startActivity(i);
                        break;
                    }
                    case 5:{
                        Intent i = new Intent(SemesterEC.this, SemesterSixEC.class);
                        startActivity(i);
                        break;
                    }
                    case 6: {
                        Intent i = new Intent(SemesterEC.this, SemesterSevenEC.class);
                        startActivity(i);
                        break;
                    }
                }
