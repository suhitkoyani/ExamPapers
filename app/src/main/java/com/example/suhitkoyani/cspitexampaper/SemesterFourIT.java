...
public class SemesterFourIT extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(SemesterFourIT.this);
    ...
    public void addSubjectData(){
        ...
        branch_obj = new Branch("Operating Systems");
        SemesterList.add(branch_obj);

        branch_obj = new Branch("Web Technologies");
        SemesterList.add(branch_obj);
