...
public class SemesterIT extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(SemesterIT.this);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(this,
            ...
            public void onClick(View view, final int position) {
                switch (position) {
                    case 0: {
                        Intent i = new Intent(SemesterIT.this, SemesterOneIT.class);
                        startActivity(i);
                        break;
                    }
                    case 1:{
                        Intent i = new Intent(SemesterIT.this, SemesterTwoIT.class);
                        startActivity(i);
                        break;
                    }
                    case 2: {
                        Intent i = new Intent(SemesterIT.this, SemesterThreeIT.class);
                        startActivity(i);
                        break;
                    }
                    case 3: {
                        Intent i = new Intent(SemesterIT.this, SemesterFourIT.class);
                        startActivity(i);
                        break;
                    }
                    case 4: {
                        Intent i = new Intent(SemesterIT.this, SemesterFiveIT.class);
                        startActivity(i);
                        break;
                    }
                    case 5:{
                        Intent i = new Intent(SemesterIT.this, SemesterSixIT.class);
                        startActivity(i);
                        break;
                    }
                    case 6: {
                        Intent i = new Intent(SemesterIT.this, SemesterSevenIT.class);
                        startActivity(i);
                        break;
                    }
                }
